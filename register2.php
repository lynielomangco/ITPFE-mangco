...
<div class="row">
    ...
    <div class="container">
        ...
        <form action="test1.php", method="POST">
           ...
           <div class="form-group">
             <b>Username</b>   <input type="text" name="user_name" id="text" required placeholder="Enter username"   oninvalid="this.setCustomValidity('Please make first letter of your name as capital')" onchange="try{setCustomValidity('')}catch(e){}"></input>
             </div>
            <div class="form-group">
              <b>Password</b>  <input type="password" name="password" id="text" placeholder="Enter new password"  title="Password should be of 6-10 length and should contain atleast one character and one number" Required>
              </div>
             <div class="form-group">
